...
$dp_percent_display = ($car_price > 0) ? round($dp_amount / $car_price * 100) : 0;
$errors = [];
    ...
    if (empty($errors)) {
        ...
        if (!move_uploaded_file($_FILES['insurance_pdf']['tmp_name'], $target_fs)) {
            ...
            try {
                ...
                mysqli_commit($conn);
                trigger_new_down_payment_alert($conn, $booking_id, $snap['user_name'] ?? '');
...
<style>
    ...
    .plate-option input:checked+label .ic {
        color: #1e293b;
        background: #e2e8f0;
    }

    .plate-option label .text {
        flex: 1;
    }

    .plate-option label .ti {
        font-size: 14px;
        font-weight: 700;
        color: #1e293b;
        margin-bottom: 4px;
    ...
    <div class="dp-wrapper">
        ...
        <div class="left-col">
            ...
            <div class="dp-card summary-card">
                ...
                <div class="summary-row deduction">
                    <span>Down Payment (<?= $dp_percent_display ?>%)</span>
            ...
            <div class="dp-card summary-card">
                ...
                <div class="summary-row total">
                    ...
                    <strong id="totalAmt">RM
                        <?= number_format($dp_amount + INSURANCE_FEE + PLATE_REG_FEE, 2) ?></strong>
                </div>
            </div>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data" autocomplete="off" id="dpForm">
                ...
                <div class="form-section">
                    ...
                    <label class="upload-zone" id="uploadZone" for="insuranceInput">
                        ...
                        <input type="file" name="insurance_pdf" id="insuranceInput" accept=".pdf,.jpg,.jpeg,.png"
                            required>
                    </label>
                </div>
                ...
                <div class="form-section">
                        ...
                        <div class="plate-option">
                            ...
                            <label for="po_new">
                                ...
                                <div class="text">
                                    ...
                                    <div class="sb">We will assign and register a new plate number for your vehicle. The
                                        plate number will be confirmed by our admin team after this payment.</div>
                                </div>
                            ...
                            <div class="plate-option">
                                ...
                                <label for="po_used">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="sb">Continue using the original plate number from this used vehicle. No
                                            new registration required.</div>
                                    </div>
                    ...
                    <div class="info-note">
                        ...
                        <span>
                            <?php if ($is_used_car): ?>
                                Choose whether to keep the existing plate or have us register a new one for you. Your
                                selected option will be reviewed by admin.
                            <?php else: ?>
                                Your new vehicle requires plate registration. Our admin team will assign a plate number
                                after verification.
                            <?php endif; ?>
                        </span>
                    </div>
