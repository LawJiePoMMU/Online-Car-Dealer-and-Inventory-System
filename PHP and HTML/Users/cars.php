        ...
        <aside class="inventory-sidebar">
            ...
            <div class="filter-group">
                ...
                <div class="filter-options">
                    <label class="custom-tick"><input type="radio" name="bodyTypeFilter" value="All" checked>
                        <div class="box"></div><span>All</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="bodyTypeFilter" value="Sedan">
                        <div class="box"></div><span>Sedan</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="bodyTypeFilter" value="SUV">
                        <div class="box"></div><span>SUV</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="bodyTypeFilter" value="Hatchback">
                        <div class="box"></div><span>Hatchback</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="bodyTypeFilter" value="EV">
                        <div class="box"></div><span>EV</span>
                    </label>
                </div>
            </div>
            ...
            <div class="filter-group">
                ...
                <div class="filter-options">
                    <label class="custom-tick"><input type="radio" name="conditionFilter" value="All" checked>
                        <div class="box"></div><span>All</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="conditionFilter" value="New Car">
                        <div class="box"></div><span>New Car</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="conditionFilter" value="Used Car">
                        <div class="box"></div><span>Used Car</span>
                    </label>
                </div>
            </div>
            ...
            <div class="filter-group">
                ...
                <div class="filter-options">
                    <label class="custom-tick"><input type="radio" name="yearFilter" value="All" checked>
                        <div class="box"></div><span>All</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="yearFilter" value="2023-2024">
                        <div class="box"></div><span>2023 - 2024</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="yearFilter" value="2020-2022">
                        <div class="box"></div><span>2020 - 2022</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="yearFilter" value="Before 2020">
                        <div class="box"></div><span>Before 2020</span>
                    </label>
                </div>
            </div>
            ...
            <div class="filter-group">
                ...
                <div class="filter-options">
                    <label class="custom-tick"><input type="radio" name="priceFilter" value="All" checked>
                        <div class="box"></div><span>All</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="priceFilter" value="Under 50k">
                        <div class="box"></div><span>Under RM 50,000</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="priceFilter" value="50k-100k">
                        <div class="box"></div><span>RM 50,000 - RM 100,000</span>
                    </label>
                    <label class="custom-tick"><input type="radio" name="priceFilter" value="Above 100k">
                        <div class="box"></div><span>Above RM 100,000</span>
                    </label>
                </div>
            </div>

            <button onclick="resetFilters()"
                style="width: 100%; padding: 12px; background: #f8fafc; color: #0f172a; border: 1px solid #cbd5e1; border-radius: 8px; font-weight: 800; cursor: pointer; transition: 0.2s;">
                RESET FILTER
            </button>
        </aside>
