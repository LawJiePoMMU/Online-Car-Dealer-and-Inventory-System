    ...
    <div class="footer-container">
        <div class="footer-grid">
            <div class="footer-col footer-about">
                <img src="../../Images\Uploads/company_logo.png" alt="LCWcar" class="footer-logo">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-contact">
                    <li>
                        ...
                        <span>168, Jalan Bukit Bintang, Bukit Bintang, 55100 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur</span>
                    </li>
                    <li>
